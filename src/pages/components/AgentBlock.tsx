...
const AgentBlock = forwardRef<AgentBlockRef, AgentBlockProps>(
  (
    {
      blockNumber,
      variables,
    ...
    const handleVariableSelect = (e: React.ChangeEvent<HTMLSelectElement>) => {
      if (e.target.value === "add_new" && onOpenTools) {
        onOpenTools();
        e.target.value = "";
      } else {
        ...
        if (response.success) {
          ...
          if (selectedVariableId) {
            ...
            if (selectedVariable) {
              ...
              onAddVariable(selectedVariable);
            }
          }
          
          if (onProcessedPrompts) {
            onProcessedPrompts(processedSystemPrompt, processedUserPrompt);
          }
      ...
      <>
                ...
                <div className="flex justify-end gap-2 mt-2">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      onSavePrompts(blockNumber, systemPrompt, userPrompt);
                      console.log(
                        `Saved Block ${blockNumber} System Prompt:`,
                        systemPrompt
                      );
                    }}
                  >
                ...
                <div className="flex justify-end gap-2 mt-2">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      onSavePrompts(blockNumber, systemPrompt, userPrompt);
                      console.log(
                        `Saved Block ${blockNumber} User Prompt:`,
                        userPrompt
                      );
                    }}
                  >
        ...
        {showOutput && (
          <div className="mt-2 pl-4 font-mono text-white text-sm opacity-75">
            <div>Block #{blockNumber} output:</div>
